...
class CreateWhatsappMarketingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('whatsapp_marketings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('whatsapp_marketings');
    }
}
