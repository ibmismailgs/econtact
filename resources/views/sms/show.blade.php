                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-bordered col-md-12">
                            <div class="btn-primary row "><span class="ml-10">SMS Details</span></div>
                            <hr>
                            ...
                            <hr>
                                ...
                                <hr>
                                <div class="form-group row">
                                    <label for="title" class="col-sm-2 col-form-label">Text Details</label>
                                    <div class="col-sm-10">
