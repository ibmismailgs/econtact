                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Edit Meeting</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{ route('meeting.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ $data->title }}" class="form-control @error('title') is-invalid @enderror" placeholder="Write title" required>
                            ...
                            <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="meeting_type_id" id="meeting_type_id" class="form-control select2 @error('meeting_type_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($meetingTypes as $key => $meetingType)
                                                <option value="{{ $meetingType->id }}" @if($data->meeting_type_id == $meetingType->id) selected @endif> {{ $meetingType->title }} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" id="date" value="{{ $data->date }}" class="form-control @error('date') is-invalid @enderror" placeholder="Write date" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="time" id="time" value="{{ $data->time }}" class="form-control @error('time') is-invalid @enderror" placeholder="Write time" required>
                                ...
                                {{-- <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <span class="d-flex">
                                            ...
                                            <span style="margin-left: 5px; height:32px; font-size:14px; text-align:center; padding-top: 8px;margin-top: 25px;" name="add" id="add" class="badge badge-success">Add Quotation : </span> &nbsp;&nbsp;

                                            <input style="width: 35px !important; height:32px !important;margin-top: 25px;" type="checkbox" name="addquotation" class="checkoption checkmark" value="1" {{ $data->addquotation == 1  ? 'checked' : '' }}></span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="quotation_type_id" id="quotation_type_id" class="form-control @error('quotation_type_id') is-invalid @enderror">
                                            ...
                                            @foreach ($quotationTypes as $key => $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $quotation->quotation_type_id ? 'selected' : '' }}> {{ $item->title }} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-4 quotation">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="quotation_no" id="quotation_no" value="{{ $quotation->quotation_no }}" class="form-control @error('quotation_no') is-invalid @enderror" placeholder="Enter quotation no">
                                ...
                                <div class="col-sm-4 quotation">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount" id="amount" value="{{ $quotation->amount }}" class="form-control @error('amount') is-invalid @enderror" placeholder="Enter amount" min="0">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="note" id="note" class="form-control" cols="10" rows="2">{!! $data->note !!}</textarea>
                                    </div>
                                </div>
                            </div>
...
@push('script')
    ...
    <script>
        ...
        $(".quotation").hide();
        var quotation = {{ $data->addquotation }};
