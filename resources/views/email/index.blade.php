                    ...
                    <div class="card-header">
                        <h3 class="d-block w-100">{{ __('Email')}}
                            ...
                            <small class="float-right">
                                <a title="Create" href="{{ route('email-marketing.create') }}" type="button" class="badge badge-primary">
...
<script>
    ...
    $(document).ready( function () {
        ...
        ajax: {
            url: "{{route('email-marketing.index')}}",
            type: "get"
        },
