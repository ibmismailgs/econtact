...
@section('title', 'Whatsapp Message List')
@section('content')
@push('head')
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Whatsapp Message List</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="card-header">
                        <h3 class="d-block w-100">{{ __('Whatsapp Message')}}
                            <small class="float-right">
                                <a title="Create" href="{{ route('whatsapp-marketing.create') }}" type="button" class="badge badge-primary">
