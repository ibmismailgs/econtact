            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline pt-5">
                        <h5 class="pt-10" >Whatsapp Message Details</h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-bordered col-md-12">
                            <div class="btn-primary row "><span class="ml-10">Whatsapp Message Details</span></div>
                            <hr>
                            ...
                            <hr>
                                ...
                                <hr>
                                <div class="form-group row">
                                    <label for="title" class="col-sm-2 col-form-label">Message Details</label>
                                    <div class="col-sm-10">
