...
@section('title', 'Edit Whatsapp Message')
@section('content')
@push('head')
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Edit Whatsapp Message</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{ route('whatsapp-marketing.update', $data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="text" id="text" class="form-control html-editor @error('text') is-invalid @enderror" cols="3" rows="3" required>{!! $data->text !!}</textarea>
