                ...
                <div class="card card-red text-white">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">{{ $quotations ?? '0' }}</h4>
                                <p class="mb-0">{{ __('Quotation')}}</p>
                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-blue text-white">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">{{ $meetings ?? '0' }}</h4>
                                <p class="mb-0">{{ __('Meetings')}}</p>
                            </div>
                            <div class="col-4 text-right">
                                <i class="fa fa-handshake f-30"></i>
                            </div>
                        </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card card-yellow text-white">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">{{ $minutes ?? '0' }}</h4>
                                <p class="mb-0">{{ __('Meeting Minutes')}}</p>
                            </div>
                            <div class="col-4 text-right">
                                <i class="fa fa-handshake f-30"></i>
                            </div>
