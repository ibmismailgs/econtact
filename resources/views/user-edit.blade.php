                        ...
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" >
                                        <label for="role">{{ __('Groups')}}</label>

                                        <select name="group_id" id="group_id" class="form-control select2">
                                            <option value="">Select Group</option>
                                            @foreach ($groups as $key => $item)
                                                <option value="{{ $item->id }}" @if($user->group_id == $item->id) selected @endif> {{ $item->title }} </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <select name="user_id" id="user_id" class="form-control select2">
                                            ...
                                            @foreach ($users as $key => $item)
                                                <option value="{{ $item->id }}"  @if($user->user_id == $item->id) selected @endif> {{ $item->name }} </option>
                                            @endforeach
                                        </select>
                                    </div>
