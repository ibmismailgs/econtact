                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Create Quotation</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{ route('quotations.store') }}" method="POST">
                            @csrf
                            <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="quotation_no" id="quotation_no" value="{{ old('quotation_no') }}" class="form-control @error('quotation_no') is-invalid @enderror" placeholder="Enter quotation no" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="amount" id="amount" value="{{ old('amount') }}" class="form-control @error('amount') is-invalid @enderror" placeholder="Enter amount" min="0" required>
