                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Division List</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3 class="d-block w-100">{{ __('Division')}}
                            @can('division_create')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">{{ __('Create Division')}}</h5>
                ...
                <div class="modal-body">
                    <form id="add-data" class="forms-sample add-data" enctype="multipart/form-data" action="#" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter division name" required>
                ...
                <div class="modal-body">
                    <form id="edit-data" action="#">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" id="editName" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter division name" required>
...
$('#update').on('click',function (event) {
        ...
        var url = '{{ route("division.update",":id") }}';
