                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline pt-5">
                            <h5 class="pt-10" >Customer Source</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3 class="d-block w-100">{{ __('Customer Source')}}
                            @can('customer_source_create')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">{{ __('Create Customer Source')}}</h5>
...
{{-- edit modal --}}
 <div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="demoModalLabel">{{ __('Edit Customer Source')}}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
...
<script>
    $(document).ready(function($){
     $('#save').on('click',function (event) {
        ...
        var url = "{{ route('client-source.store') }}";
        var title = $('#title').val();
...
$('#update').on('click',function (event) {
        ...
        var url = '{{ route("client-source.update",":id") }}';
    ...
    if (changeStatus) {
        $.ajax({
            'url':"{{ route('client-source.status') }}",
            'type':'get',
            'dataType':'json',
            'data':{id:id},
            success:function(data)
